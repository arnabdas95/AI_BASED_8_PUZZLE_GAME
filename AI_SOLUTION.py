...
def get_best_huristic_from_queue():
       node_queue.sort(key=lambda x: x[1])
       return node_queue[0]

# Global variable declare
GOAL_STATE = [1, 2, 3, 4, 5, 6, 7, 8, 9]
#INITIAL_STATE = [2,7,3,5,9,4,1,6,8]  #give result
#INITIAL_STATE= [1,3,4,8,6,2,7,9,5] #easy
#INITIAL_STATE = [1, 2, 5, 4, 3, 6, 7, 9, 8]
INITIAL_STATE = [4,1,3,7,2,5,8,9,6] #easy give result
INITIAL_STATE = [4,2,3,7,1,6,8,9,5] #easy give result
...
node_queue =[]
node_queue.append([INITIAL_STATE,0,None])
...
while(len(node_queue) >0):
    ...
    if left_move_child !=None:
       ...
       if left_move_child not in vs:
            ...
            if left_move_child != GOAL_STATE:
              ...
              node_queue.append([left_move_child,left_child_total_huristic_cost,'LEFT_MOVE'])
    ...
    if right_move_child != None:
        ...
        if right_move_child not in vs:
            ...
            if right_move_child != GOAL_STATE:
                ...
                node_queue.append([right_move_child, right_child_total_huristic_cost, 'RIGHT_MOVE'])
    ...
    if up_move_child != None:
        ...
        if up_move_child not in vs:
            ...
            if up_move_child != GOAL_STATE:
                ...
                node_queue.append([up_move_child, up_child_total_huristic_cost, 'UP_MOVE'])
    ...
    if down_move_child != None:
        ...
        if down_move_child not in vs:
            ...
            if down_move_child != GOAL_STATE:
                ...
                node_queue.append([down_move_child, down_child_total_huristic_cost, 'DOWN_MOVE'])
   ...
   # print("huristic function calculated")
    ...
    desired_move =( get_best_huristic_from_queue())
    initial_to_goal_path.append(desired_move[2])
    print(desired_move)
    node = Node(desired_move[0], node.state,desired_move[2], desired_move[1], node.depth + 1)


    print(f"depth={node.depth},state={node.state},move={node.move}")

print(initial_to_goal_path)
print(len(initial_to_goal_path))